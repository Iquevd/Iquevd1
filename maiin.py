...
grupos = {'1':'No metal','2':'Gas noble','3':'Semimetal','4':'Metal','5':'Lantanido','6':'Actinido','7':'Alcalinoterreo','8':'Alcalino','9':'Desconocido'}
print("Bienvenido a la Tabla Periódica de los Elementos!")
print("Ingrese el grupo de la Tabla Periopdica que desea investigar: ")
print("1.No metal\n2.Gas noble\n3.Semimetal\n4.Metal\n5.Lantanido\n6.Actinido\n7.Alcalinoterreo\n8.Alcalino\n9.Desconocido")
eleccion=input()
gr_eleccion=grupos[eleccion]
list_elem=[]
for i in tabla_periodica:
    if tabla_periodica[i]['Grupo']==gr_eleccion:
        list_elem.append(i)
print("Los elementos de la tabla periódica pertenecientes a",gr_eleccion,"son: ",list_elem)
...
for i in tabla_periodica:
    ...
    break
while True:
    print("Desea saber la informacion de algun otro grupo o elemento?","\n","Si/No")
    eleccion2=input()
    if eleccion2=="Si":
        print("Desea saber un grupo o un elemento?","\n","Grupo/Elemento")
        eleccion3=input()
        if eleccion3=="Grupo":
            print("1.No metal\n2.Gas noble\n3.Semimetal\n4.Metal\n5.Lantanido\n6.Actinido\n7.Alcalinoterreo\n8.Alcalino\n9.Desconocido")
            eleccion4=input()
            gr_eleccion=grupos[eleccion4]
            list_elem=[]
            for i in tabla_periodica:
                if tabla_periodica[i]['Grupo']==gr_eleccion:
                    list_elem.append(i)
