...
print("Ingrese por favor la opcion que desee buscar el elemento: 1(Símbolo) y/o 2(Número Atómico)")
opcion=int(input())
if opcion==1:
    simbolo=input("Ingrese el símbolo del elemento químico: ")
    print("La información del elemento",simbolo,"es",tabla_periodica[simbolo])
elif opcion==2:
    numero_atomico=input("Ingrese el número atomico del elemento: ") 
